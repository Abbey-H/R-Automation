...
#STEP 1- LOADING DATA
datapath <- "/Volumes/Mac HD/Users/hamme433/Desktop/Raw Data/" #what folder the data is located in the directory
...
savepath.PreACQ <- "/Users/hamme433/Desktop/Parsed Data/PreACQ/" #Phase 1 (PreACQ) data being stored here
savepath.ACQ <- "/Users/hamme433/Desktop/Parsed Data/ACQ/" #Phase 2 (ACQ) data being stored here
savepath.GEN <- "/Users/hamme433/Desktop/Parsed Data/GEN/" #Phase 3 (GEN) data being stored here
...
for(i in 1:length(filenames)){ #for each data file specified in filenames: 
  ...
  #Parse Data based on variable "Phase"; change as you wish. For more complex data parsing, I recommend using the "dplyr" package if you can. 
